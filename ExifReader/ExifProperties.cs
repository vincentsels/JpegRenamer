...
{
	/// <summary>
	/// Dictionary containing all possible EXIF properties, with the key
	/// as Id and a descriptive English string as value.
	/// </summary>
	public class ExifProperties : Dictionary<int, string>
	{
		public ExifProperties()
		{
			Add(0x8769, "Exif IFD");
			Add(0x8825, "Gps IFD");
